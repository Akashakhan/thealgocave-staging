...
export default function Footer() {
  return (
    <section className="bg-gray-800 text-white py-20 px-6 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Ready to unlock the real value of your data?
          </h2>
          <button className="bg-gray-700 text-white px-8 py-4 rounded-lg flex items-center space-x-2 mx-auto hover:bg-gray-600 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-semibold">The AlgoCave</span>
            </div>
